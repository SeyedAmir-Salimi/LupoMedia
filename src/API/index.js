...
export default function API() {
    ...
    return {
        ...
        async getNotifications(ID){
            try {
                const result = await Axios.get(`http://localhost:3000/notifications/${ID}`)
                return result.data
            } catch (error) {
                console.log(error);
            }
        ...
        async changeNotificationStatus(data){
            try {
                const result = await Axios.put(`http://localhost:3000/notifications/read`, data )
                return result
            } catch (error) {
                throw new Error(error.response.data)
            }
        ...
        async allNoficicationRead(data){
            try {
                const result = await Axios.put(`http://localhost:3000/notifications/allread`, data )
                return result
            } catch (error) {
                throw new Error(error.response.data)
            }
