...
export default function API () {
  return {
    async DeletePost (id, user) {
      await Axios.delete(`https://lupomedia-api.herokuapp.com/posts/${id}`, {
        data: { user: user }
      })
    },
    async DeletePostPhoto (id) {
      try {
        const result = await Axios.delete(
          `https://lupomedia-api.herokuapp.com/files/photoPost/${id}`
        )
        return result
      } catch (error) {
        console.log(error)
    ...
    async DeleteComment (id, postref) {
      await Axios.delete(`https://lupomedia-api.herokuapp.com/comments/${id}`, {
    ...
    async DeleteReplyComment (id, postref) {
      try {
        const result = await Axios.delete(
          `https://lupomedia-api.herokuapp.com/comments/reply/${id}`,
          { data: { postref: postref } }
        )
        return result
      } catch (error) {
    ...
    async AddPostwithoutpic (contextid, PostCaption) {
      const result = await Axios.post(
        `https://lupomedia-api.herokuapp.com/posts/withoutpicture`,
        {
          user: contextid,
          caption: PostCaption
        }
    ...
    async AddPostwithpic (contextid, PostCaption, extension) {
      ...
      const result = await Axios.post(
        `https://lupomedia-api.herokuapp.com/posts/withpicture`,
        data,
        ID,
        CAPTION,
        EXTENSION
    ...
    async SearchUser (typedName) {
      ...
      const result = await Axios.get(
        `https://lupomedia-api.herokuapp.com/users/search/${name}`
      )
      return result
    },
    ...
    async deletePictureprofile (ID) {
      try {
        const result = await Axios.delete(
          `https://lupomedia-api.herokuapp.com/files/photoProfile/${ID}`
        )
        return result
      } catch (error) {
        console.log(error)
    ...
    async updatePassword (ID, data, config) {
      try {
        const result = await Axios.put(
          `https://lupomedia-api.herokuapp.com/datiPersonali/changepassword/${ID}`,
          data,
          config
        )
        return result
    ...
    async getFollowingAccepted (ID) {
      try {
        const result = await Axios.get(
          `https://lupomedia-api.herokuapp.com/friends/followingAcc/${ID}`
        )
        return result
      } catch (error) {
        console.log(error)
    ...
    async getFollowersAccepted (ID) {
      try {
        const result = await Axios.get(
          `https://lupomedia-api.herokuapp.com/friends/followersAcc/${ID}`
        )
        return result
      } catch (error) {
        console.log(error)
    ...
    async getFollowingAwaiting (ID) {
      try {
        const result = await Axios.get(
          `https://lupomedia-api.herokuapp.com/friends/followingAw/${ID}`
        )
        return result
      } catch (error) {
        console.log(error)
    ...
    async getFollowersAwaiting (ID) {
      try {
        const result = await Axios.get(
          `https://lupomedia-api.herokuapp.com/friends/followersAw/${ID}`
        )
        return result
      } catch (error) {
        console.log(error)
    ...
    async SendFriendRequest (mainUserData, secondUserData, situationshipData) {
      try {
        const result = await Axios.post(
          `https://lupomedia-api.herokuapp.com/friends/request`,
          {
    ...
    async deleteFriendRequest (_id, mainUserData, secondUserData) {
      try {
        const result = await Axios.delete(`https://lupomedia-api.herokuapp.com/friends`, {
          data: { _id: _id, mainUser: mainUserData, secondUser: secondUserData }
        })
        return result
      } catch (error) {
        throw new Error(error.response.data)
    ...
    async forgetPassword (data) {
      try {
        const result = await Axios.put(
          `https://lupomedia-api.herokuapp.com/resetPassword`,
          data
        )
        return result
      } catch (error) {
    ...
    async resetPassword (data, config) {
      try {
        const result = await Axios.patch(
          `https://lupomedia-api.herokuapp.com/resetPassword/set`,
          data,
          config
        )
        return result
    ...
    async DeleteLike (postref, user) {
      try {
        await Axios.delete(`https://lupomedia-api.herokuapp.com/likes`, {
          data: { postref, user }
        }).then(res => {
    ...
    async getNotifications (ID) {
      try {
        const result = await Axios.get(
          `https://lupomedia-api.herokuapp.com/notifications/${ID}`
        )
        return result.data
      } catch (error) {
        console.log(error)
    ...
    async deleteNotification (notifId) {
      try {
        const result = await Axios.delete(
          `https://lupomedia-api.herokuapp.com/notifications/${notifId}`
        )
        return result
      } catch (error) {
        throw new Error(error.response.data)
    ...
    async changeNotificationStatus (data) {
      try {
        const result = await Axios.put(
          `https://lupomedia-api.herokuapp.com/notifications/read`,
          data
        )
        return result
      } catch (error) {
    ...
    async allNoficicationRead (data) {
      try {
        const result = await Axios.put(
          `https://lupomedia-api.herokuapp.com/notifications/allread`,
          data
        )
        return result
      } catch (error) {
    ...
    async addGoal (contextid, PostCaption, goalAchievementDate) {
      const result = await Axios.post(`https://lupomedia-api.herokuapp.com/posts/goal`, {
        user: contextid,
        caption: PostCaption,
        goalAchievementDate
      })
    ...
    async editGoalReached (data) {
      try {
        const result = await Axios.put(`https://lupomedia-api.herokuapp.com/posts/goal`, data)
        return result
      } catch (error) {
        throw new Error(error.response.data)
      }
