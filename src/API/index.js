...
export default function API() {
    ...
    return {
        ...
        async getNotifications(ID){
            try {
                const result = await Axios.get(`https://lupomedia-api.herokuapp.com/notifications/${ID}`)
                return result.data
            } catch (error) {
                console.log(error);
            }
        ...
        async deleteNotification(notifId) {
            try {
                await Axios.delete(`https://lupomedia-api.herokuapp.com/notifications/${notifId}`)
                    .then(res => {
                        console.log(res.data)
                    })
            } catch (error) {
        ...
        async changeNotificationStatus(data){
            try {
                const result = await Axios.put(`https://lupomedia-api.herokuapp.com/notifications/read`, data )
                return result
            } catch (error) {
                throw new Error(error.response.data)
            }
        ...
        async allNoficicationRead(data){
            try {
                const result = await Axios.put(`https://lupomedia-api.herokuapp.com/notifications/allread`, data )
                return result
            } catch (error) {
                throw new Error(error.response.data)
            }
